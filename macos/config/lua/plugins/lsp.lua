-- LSP and completion configuration (macOS version)
...
return {
  ...
  -- Mason: LSP server manager
  {
    ...
    config = function()
      require("mason").setup({
        -- macOS: use default data dir, Mason manages downloads automatically
        ui = {
          icons = {
            package_installed = "✓",
            package_pending = "➜",
  ...
  -- Mason LSP config bridge
  {
    ...
    config = function()
      require("mason-lspconfig").setup({
        ...
        automatic_installation = true, -- Mason auto-installs on macOS
      })
    end,
  },
    ...
    config = function()
      ...
      if ok then
        ts_configs.setup({
          ...
          sync_install = false,
          auto_install = true,  -- macOS: auto install parsers on demand
          highlight = {
            enable = true,
